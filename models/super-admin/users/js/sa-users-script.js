    ...
    */
        // User registration
            ...
            $("#NewUserForm").on("submit", (e)=>{
                ...
                $.ajax({
                    url:'../models/super-admin/users/server/new-user-script.php',
                    method:'POST',
                    cache:false,
                    contentType:false,
                    processData:false,
        ...
        $("#UserAccountUpdate").on("show.bs.modal", (event)=>{
            ...
            $.ajax({
                url:'../models/super-admin/users/server/user-data-script.php',
                method:'GET',
                cache:false,
        ...
        $("#UserAccountUpdateForm").on("submit", (e)=>{
            ...
            e.preventDefault()
            $.ajax({
                url:'../models/super-admin/users/server/user-info-data-update-script.php',
                method:'POST',
                cache:false,
        ...
        $("#UserIdentityUpdateForm").on("submit", (e)=>{
            ...
            e.preventDefault()
            $.ajax({
                url:'../models/super-admin/users/server/user-identity-data-update-script.php',
                method:'POST',
                contentType:false,
                processData:false,
                data: new FormData(form_data),
        ...
        $("#UserAccountTypeForm").on("submit", (e)=>{
            ...
            e.preventDefault()
            $.ajax({
                url:'../models/super-admin/users/server/user-type-data-update-script.php',
                cache:false,
                method:'POST',
        ...
        $("#UserAccountStatusForm").on("submit", (e)=>{
            ...
            e.preventDefault()
            $.ajax({
                url:'../models/super-admin/users/server/user-status-data-update-script.php',
                cache:false,
                method:'POST',
        ...
        $("#UserAccountResetForm").on("submit", (e)=>{
            ...
            e.preventDefault()
            $.ajax({
                url:'../models/super-admin/users/server/user-reset-data-update-script.php',
                cache:false,
                method:'POST',
        ...
        $("#UserAccountDeleteForm").on("submit", (e)=>{
            ...
            e.preventDefault()
            $.ajax({
                url:'../models/super-admin/users/server/user-delete-data-update-script.php',
                cache:false,
                method:'POST',
